...
This is the sample app with a lot of cat counters that we played with at the end of the Prototyping With Polaris repo. Enjoy! :)

The rest of this readme was generated by `create-react-app`

To play with it immediately:
- clone the repo or download and extract the zip
- go to the directory in your terminal
- open `src/App.js` with your code editor
